...
const ARTISTS = [
  ...
  { slug: 'oasis',              name: 'Oasis',               search: 'Oasis',               genre: 'Britpop / Rock',               description: 'Oasis are one of the most iconic British rock bands of all time, known for anthems including Wonderwall, Don\'t Look Back in Anger and Champagne Supernova. The Gallagher brothers\' reunion tour is one of the most anticipated live events in years, with millions of fans worldwide scrambling for tickets.' },
  { slug: 'the-killers',        name: 'The Killers',         search: 'The Killers',         genre: 'Indie Rock / Alternative',     description: 'The Killers are an American rock band from Las Vegas known for their synth-driven anthems and electrifying live performances. With hits including Mr Brightside and Human, they are one of the best-selling artists of the 21st century and a fixture at major arenas and festivals worldwide.' }
];
