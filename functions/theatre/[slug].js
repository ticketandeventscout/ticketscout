...
//
// ONLY runs when no static file exists at theatre/[slug].html
// ===========================

export async function onRequestGet({ request, params }) {
  try {
    const slug = (params.slug || '').toLowerCase().replace(/[^a-z0-9-]/g, '');
    if (!slug) return Response.redirect('https://www.ticketscout.co.uk/theatre.html', 302);
    ...
    return Response.redirect('https://www.ticketscout.co.uk/theatre.html', 302);
  }
}
